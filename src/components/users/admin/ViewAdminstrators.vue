          ...
          <v-card
            ...
            <v-card-text>
              ...
              <v-avatar
                ...
                size="88">
                <v-img
                  :src="`https://avataaars.io/${avatar}`"></v-img>
              </v-avatar>
              <v-btn flat small fab dark color="red">
  ...
  export default {
    ...
    methods: {
      async fetchUsers(item) {
        /*
        * Remove this below line in 6 months and say u have done some optimizations. ^KB Peace out
        * */
        await pause(1500);
